...
Based on the first two part result, analysis is done. There are three kind of analysis:

### R Installation Failure Analysis

An analysis why an R implementation can not be installed on a platform will be done. If possible, a fix for the problem will be done through the research.

### R Package Installation Failure Analysis

An analysis why an R packages can not be installed on a combination of R implementation platform will be done. If possible, a fix for the problem will be done through the research.

### Benchmark Analysis

The result of the benchmark will be analysed.